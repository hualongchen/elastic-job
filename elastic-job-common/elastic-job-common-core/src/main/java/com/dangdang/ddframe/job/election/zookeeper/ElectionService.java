...
package com.dangdang.ddframe.job.election.zookeeper;

import com.dangdang.ddframe.job.election.ElectionCandidate;
...
public final class ElectionService implements AutoCloseable {
    ...
    @Builder
    private ElectionService(final String identity, final String electionPath, final CuratorFramework client, final ElectionCandidate electionCandidate) {
